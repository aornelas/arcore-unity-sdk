...
{
    public class ARCoreForTownPeopleController : MonoBehaviour
    {

        /// <summary>
        /// The Town Controller to use to place town
        /// </summary>
        public TownPeopleController m_townPeopleController;
        ...
        public void ARUpdate ()
        {
            ...
            if (Session.Raycast (m_firstPersonCamera.ScreenPointToRay (touch.position), raycastFilter, out hit)) {
                ...
                GameObject townObject = m_townPeopleController.PlaceTown (hit.Point, anchor.transform);
